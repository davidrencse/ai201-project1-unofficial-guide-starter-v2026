...
**Chunk size:** 600 characters (target)
...
I selected the campus_life corpus, which contains 88 short
documents about university life. The documents contain
information about dining halls, housing, courses, and
administrative policies.

I chose a target size of 600 characters because the
longest document in my initial indexing run was 549
characters. This allows short posts to remain intact
instead of splitting important information across
multiple chunks.

My chunking function splits documents at paragraph
boundaries and combines paragraphs when they fit within
the target size.

I chose zero overlap because the documents are short,
and preserving complete paragraphs maintains the
context needed to answer questions.

After implementing my strategy, the application
generated 88 chunks from 88 documents, with an average
length of 317 characters.

All five sampled chunks contained complete sentences
and enough context to understand their information
independently.
